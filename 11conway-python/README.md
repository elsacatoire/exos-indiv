...
Une telle suite s'appelle [Suite de Conway] ([https://fr.wikipedia.org/wiki/Suite_de_Conway](https://fr.wikipedia.org/wiki/Suite_de_Conway)) ou suite "audioactive".
